                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0 additional-css">
                            <div class="card-body pt-4 shadow">                       
                                ...
                                <div class="form-group">
                                    <label >Salary :</label>
                                    <input type="number" class="form-control additional-css" value="<?php echo $salary; ?>" name="salary" >  
                                    <?php echo $salaryErr; ?>            
                                </div>

                                <div class="form-group">
                                    <label >Date-of-Birth :</label>
                                    <input type="date" class="form-control additional-css" value="<?php echo $dob; ?>" name="dob" >  
