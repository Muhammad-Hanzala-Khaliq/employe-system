...
.bg{
  background-image: linear-gradient(rgba(246, 246, 246, .3), rgba(0, 120, 170, .3));
  height: 100%; 
  border-image: linear-gradient(rgba(246, 246, 246, .3), rgba(0, 120, 170, .3)) fill 1;
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mt-5">
                            <div class="card-body shadow">   
                                    ...
                                    <h2 class="text-center pb-4 color-gray">Employee Management System</h2>
