                            ...
                            <div class="card-body pt-5 shadow">
                                ...
                                <form method="POST" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                                    ...
                                    <div class="form-group">
                                        <label >Reason :</label>
                                        <input type="text" class="form-control additional-css" value="<?php echo $reason; ?> " name="reason" >  
                                        <?php echo $reasonErr; ?>           
                                    </div>

                                    <div class="form-group">
                                        <label >Staring Date :</label>
                                        <input type="date" class="form-control additional-css"  value="<?php echo $startdate; ?>"  name="startDate" >
                                        <?php echo $startdateErr; ?>
                                    </div>
                                    <div class="form-group">
                                        <label >Last Date :</label>
                                        <input type="date" class="form-control additional-css"  value="<?php echo $lastdate; ?>"  name="lastDate" >
