...
<div class="container ">
    ...
    <div class="row mt-5 ">
        <div class="col-4">
            <div class="card shadow additional-2" style="width: 18rem;">
                <ul class="list-group list-group-flush additional-2">
        ...
        <div class="col-4">
            <div class="card shadow additional-css" style="width: 18rem;">
    ...
    <div class="row mt-5 additional-css shadow "> 
    <div class="col-12">
